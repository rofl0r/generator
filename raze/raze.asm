...
%macro CHECK_IRQ 0
   cmp [z80_IRQLine], byte 0    ; check the IRQ line
   je near %%finish
   cmp [z80_IFF1], byte 0       ; check ints are enabled
   je near %%finish
...
%endif
   ...
   mov [z80_halted], byte 0 ; Un-HALT the Z80
...
%macro POP_RR 1
   ...
   MEMREAD
   %ifidn %1, AF
      mov [z80_flag35], dl      ; take out bits 3/5
   %endif
   mov lz%1, dl
   inc zSP
   mov edi, ezSP
...
%macro RETI 0
   ...
   mov dl, [z80_IFF2]
   mov [z80_IFF1], dl
   call [z80_RetI]           ; signal the user handler
...
%macro EI 0
   ...
   mov [z80_TempICount], eax    ; after the next instruction.
...
z80_finish:
   cmp [z80_afterEI], byte 1    ; test for the post-EI behaviour
...
z80_emulate:
   ...
   mov ezPC, [z80_PC]
   mov zR,   [z80_R]
   mov [z80_flag35], zF      ; take out bits 3/5
   cmp [z80_halted], byte 0
   je not_halted
...
%endif
   ...
   mov [z80_halted], byte 0  ; Un-HALT us.
